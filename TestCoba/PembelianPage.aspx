<%@ Page Title="" Language="C#" MasterPageFile="~/Visitor.Master" AutoEventWireup="true" CodeBehind="PembelianPage.aspx.cs" Inherits="TestCoba.PembelianPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>List Pembelian
                        <div class="page-title-subheading">Halaman Untuk Memuat Seluruh List Pembelian Dengan Periode Tertentu.
                        </div>
                    </div>
                </div>
        ...
        <table>
            <tr>
                <td id="btnValVsbl" runat="server"><a href="AddPembelianPage.aspx" class="btn btn-primary">Tambah Invoice Pembelian</a></td>
                <td>&nbsp;</td>
                <td>
                ...
                <td>
                    ...
                    <asp:DropDownList ID="ddlSortBy" runat="server" CssClass="form-control">
                        <asp:ListItem Text="" Value=""></asp:ListItem>
                        <asp:ListItem Text="-------------------" Value=""></asp:ListItem>
                        <asp:ListItem Text="Invoice" Value="a.NoInvoicePembelian"></asp:ListItem>
                        <asp:ListItem Text="Jenis Tagihan" Value="a.JenisTagihan"></asp:ListItem>
                        <asp:ListItem Text="Pembelian" Value="a.TotalTagihanPembelian"></asp:ListItem>
                        <asp:ListItem Text="Tanggal Beli" Value="a.TanggalPOPembelian"></asp:ListItem>
                        <asp:ListItem Text="Jatuh Tempo" Value="a.TanggalPOJatuhTmpPembelian"></asp:ListItem>
        ...
        <table class="mb-0 table">
                ...
                <asp:Repeater ID="RepeaterListPembelian" runat="server" OnItemDataBound="RepeaterListPembelian_ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <%#Eval("TanggalPOJatuhTmpPembelian")%>
                            </td>
                            <td>
                                <%#Eval("JenisTagihan")%>
                            </td>
                            <td>
                                <%#Eval("TotalTagihanPembelian", "{0:c}")%>
                            </td>
                            <td>
                                <%#Eval("IvnStorage")%>
                            </td>
                            <td id="pmbStatus" runat="server">
                                <%#Eval("StatusInvoicePembelianMst")%>
                            </td>
                            <td id="tdVal0" runat="server">
                                <a href="AddPembelianPage.aspx?id=<%#Eval("IdPOPembelianMst")%>&status=EDIT" /><span class="btn btn-danger">Edit</span>
                            </td>
                            <td id="tdVal1" runat="server">
                                <a href="ViewPembelianPage.aspx?id=<%#Eval("IdPOPembelianMst")%>" /><span class="btn btn-alternate">View</span>
                            </td>
                            <td id="tdVal2" runat="server">
                                <asp:Button id="btnCetakGnrt" CssClass="btn btn-info" runat="server" Text="Cetak" CommandArgument='<%#Eval("IdPOPembelianMst") %>' OnClick="btnCetakGnrt_Click" />
                            </td>
                            <td id="tdVal3" runat="server">
                                <a href="AddPembelianPage.aspx?id=<%#Eval("IdPOPembelianMst")%>" /><span class="btn btn-warning">Retur</span>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
            ...
            <tfoot>
                <tr>
                    <td colspan="3">Total Pembelian Per Hari : </td>
                    <td colspan="2"><asp:Label ID="GTQty" runat="server" CssClass="font-weight-bold" Text="0,00 KG"></asp:Label></td>
                    <td colspan="3">
