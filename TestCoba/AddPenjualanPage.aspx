<%@ Page Title="" Language="C#" MasterPageFile="~/Visitor.Master" AutoEventWireup="true" CodeBehind="AddPenjualanPage.aspx.cs" Inherits="TestCoba.AddPenjualanPage" Culture="en-US" UICulture="en-US" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Label ID="lblHeaderPage" runat="server" Text="Tambah Penjualan"></asp:Label>
                        <div class="page-title-subheading">Halaman Ini Untuk Menambahkan Atau Me-Retur Data Penjualan.
                        </div>
                    </div>
                </div>
        ...
        <div class="card-body">
            ...
            <asp:Label ID="lblStatusPage" runat="server" Text="Tambah Penjualan"></asp:Label></h5>
            <div class="form-row">
                <div class="col-md-2">
                    <div class="position-relative form-group">
                        <asp:Label ID="lblNoInvoice" runat="server" Text="No Invoice"></asp:Label>
                        <asp:TextBox ID="txtNoInvoice" runat="server" Enabled="false" placeholder="No Invoice" CssClass="form-control text-uppercase" required="required"></asp:TextBox>
                ...
                <div class="col-md-2">
                    <div class="position-relative form-group">
                        ...
                        <asp:DropDownList ID="ddlCustName" runat="server" CssClass="form-control"></asp:DropDownList>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="position-relative form-group">
                ...
                <div class="col-md-2">
                    <div class="position-relative form-group">
                        ...
                        <asp:DropDownList ID="ddlJenisTagihan" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlJenisTagihan_SelectedIndexChanged">
                            <asp:ListItem Text="Kontrabon" Value="KONTRABON"></asp:ListItem>
                            <asp:ListItem Text="Cash" Value="CASH"></asp:ListItem>
                            <asp:ListItem Text="Transfer" Value="TRANSFER"></asp:ListItem>
                            <asp:ListItem Text="Giro" Value="GIRO"></asp:ListItem>
                            <asp:ListItem Text="Cicilan" Value="CICILAN"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                <div id="ddlCclVis" runat="server" class="col-md-2" visible="false">
                    <div class="position-relative form-group">
                        <asp:Label ID="lblCicilan" runat="server" Text="Jangka" Visible="false"></asp:Label>
                        <asp:DropDownList ID="ddlCicilan" runat="server" CssClass="form-control" Visible="false">
                            <asp:ListItem Text="1x" Value="1"></asp:ListItem>
                            <asp:ListItem Text="2x" Value="2"></asp:ListItem>
                            <asp:ListItem Text="3x" Value="3"></asp:ListItem>
                            <asp:ListItem Text="4x" Value="4"></asp:ListItem>
                            <asp:ListItem Text="5x" Value="5"></asp:ListItem>
                            <asp:ListItem Text="6x" Value="6"></asp:ListItem>
                            <asp:ListItem Text="7x" Value="7"></asp:ListItem>
                            <asp:ListItem Text="8x" Value="8"></asp:ListItem>
                            <asp:ListItem Text="9x" Value="9"></asp:ListItem>
                            <asp:ListItem Text="10x" Value="10"></asp:ListItem>
                            <asp:ListItem Text="11x" Value="11"></asp:ListItem>
                            <asp:ListItem Text="12x" Value="12"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="position-relative form-group">
                        <asp:Label ID="lblJtuhTempo" runat="server" Text="Tanggal Pelunasan"></asp:Label>
                ...
                <div class="col-md-2">
                    <div class="position-relative form-group">
                        ...
                        <asp:TextBox ID="txtBrgNameBank" runat="server" Text="BCA - 2811145388" Enabled="false" CssClass="form-control" required="required"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="position-relative form-group">
...
<%--                <div class="col-md-2">
            ...
            <div id="table_box_bootstrap" class="table table-responsive table-light table-hover">
                <table class="mb-0 table">
                    <asp:Repeater ID="rptPenjualanDtl" runat="server">
                    <HeaderTemplate>
                        <tr>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPrice" runat="server" placeholder="0" CssClass="form-control" AutoPostBack="true" onfocus="this.value=''" onkeypress="return allowOnlyNumber(event);" required="required" OnTextChanged="txtPrice_TextChanged"></asp:TextBox>
                            </td>
                            <td>
                ...
                <tr>
                    <td colspan="4" style="vertical-align:top">
                        ...
                        <asp:Button ID="bckBtn" runat="server" CssClass="mt-2 btn btn-danger" UseSubmitBehavior="false" CausesValidation="false" Text="Back" OnClick="bckBtn_Click" /><br />
                    </td>
                    <td>
                        <div class="position-relative form-group">
                            <asp:Label ID="lblGrandTotal" runat="server" Text="Grand Total : "></asp:Label>
                            <asp:TextBox ID="txtGrandTotal" runat="server" CssClass="form-control" Enabled="false" Text="0"></asp:TextBox><br />
                            <asp:TextBox ID="txtCicilanJumlah" runat="server" CssClass="form-control" Visible="false" Text="Rp0" onfocus="this.value=''" onkeypress="return allowOnlyNumber(event);" required="required"></asp:TextBox>
                        </div>
                    </td>
