...
namespace TestCoba
{
    public class ITextEvents : PdfPageEventHelper
    {
        ...
        {
            DataRow drMst = GetData("SELECT * FROM POPembelianMst a INNER JOIN Supplier b on a.IdSupplier = b.IdSupplier WHERE IdPOPembelianMst = " + parametro).Rows[0];
            DataTable drDtl = GetData("SELECT B.BarangItemCode,B.NamaBarang,A.QtyBarangPOPembelianDtl,A.JumlahBoxPOPembelianDtl,A.HargaPOPembelianDtl,A.TotalHargaPOPembelianDtl FROM POPembelianDtl A INNER JOIN Barang B ON A.IdBarang = B.IdBarang WHERE A.IdPOPembelianMst = " + parametro);
            ...
            Phrase p1Header = new Phrase(drMst["SupplierName"].ToString(), baseFontBig);
            ...
            //Row 2
            PdfPCell pdfCell4 = new PdfPCell(new Phrase(drMst["SupplierAddress"].ToString() + "\n" + drMst["SupplierPhone"].ToString() + "\n" + drMst["SupplierEmail"].ToString(), baseFontNormal));
            ...
            pdfTab.TotalWidth = document.PageSize.Width - 80;
            pdfTab.WidthPercentage = 100;
