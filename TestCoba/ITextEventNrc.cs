...
namespace TestCoba
{
    public class ITextEventNrc : PdfPageEventHelper
    {
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            Phrase p1Header = new Phrase("PT Yoga Mandiri", baseFontBig);
            ...
            //    cb.BeginText();
            //    cb.SetFontAndSize(bf, 8);
            //    cb.SetTextMatrix(document.PageSize.GetRight(550), document.PageSize.GetBottom(60));
            //    cb.ShowText(sign1);
            //    cb.EndText();
            ...
            //    cb.BeginText();
            //    cb.SetFontAndSize(bf, 8);
            //    cb.SetTextMatrix(document.PageSize.GetRight(550), document.PageSize.GetBottom(10));
            //    cb.ShowText(sign2);
            //    cb.EndText();
            ...
            cb.MoveTo(40, document.PageSize.GetBottom(200));
            cb.LineTo(document.PageSize.Width - 40, document.PageSize.GetBottom(200));
            cb.Stroke();
        }
